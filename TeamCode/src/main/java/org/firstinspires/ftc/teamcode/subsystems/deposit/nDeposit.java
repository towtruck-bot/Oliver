...
public class nDeposit {
    ...
    public static double transferArm = 0.4578, transferClaw = -0.9, transferBufferZ = 12, transferZ = 7.2;
    ...
    public static double sampleLZ = 15, sampleHZ = 28, sampleLongLZ = 18, sampleLongHZ = 37, speciZ = 18, targetZ = sampleHZ;
