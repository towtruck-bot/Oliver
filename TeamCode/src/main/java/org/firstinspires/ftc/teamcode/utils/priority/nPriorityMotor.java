...
public class nPriorityMotor extends PriorityDevice {
    double lastPower = 0;
    ...
    public nPriorityMotor(DcMotorEx motor, String name, double basePriority, double priorityScale, double multiplier, nSensors sensors) {
        this(new DcMotorEx[] {motor}, name, basePriority, priorityScale, new double[]{multiplier}, sensors);
    }

    public nPriorityMotor(DcMotorEx motor, String name, double basePriority, double priorityScale, nSensors sensors) {
